...
int main(){
    system("cls");
    TARGET target;
    char str[] = "axbHaxbzezazbzxzblzazbzbzxzbzlabxzbzbzozbaxbz bzazbzxbWzazbzbzxzbzozabzxzbzrzbzazbzxlbabxzbzdbazx";
    removeChara(str, 'z');
    removeChara(str, 'b');
    removeChara(str, 'a');
    removeChara(str, 'x');
    ...
    string tempStr = convertToString(str, sizeof(str)/ sizeof(char));

    target.goal1 = tempStr.substr(0, 5);
    target.goal2 = tempStr.substr(6, 10); 
